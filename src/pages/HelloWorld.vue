...
const createShop = () => {
  shops.value = true
  shopItems.value = getRandomUniqueElements(store.getters.getCommon, common.value)
      .concat(getRandomUniqueElements(store.getters.getLegendary, legendary.value))
      .concat(getRandomUniqueElements(store.getters.getNone, none.value))
      .concat(getRandomUniqueElements(store.getters.getUnknown, unknown.value))
      .concat(getRandomUniqueElements(store.getters.getRare, rare.value))
      .concat(getRandomUniqueElements(store.getters.getVeryRare, veryRare.value))
      .concat(getRandomUniqueElements(store.getters.getArtifact, artifact.value))
      .concat(getRandomUniqueElements(store.getters.getUncommon, uncommon.value))
}
